...
namespace BackPTAlmaArchivo
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<PTAlmaArchivoDbContext>(options =>
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BackPTAlmaArchivo API", Version = "v1" });
